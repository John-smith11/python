'''
1.包就是包含有__init__.py文件的文件夹

2.为何要有包
    包的本质是模块的一种形式，包是用来当做模块导入的
'''
import foo
# 1.产生一个名称空间
# 2.运行包下的__init__.py文件，将运行过程中产生的名字弄到1的名称空间中
# 3.在当前执行文件的名称空间中拿到一个名字foo，foo指向1的名称空间

# 使用
foo.f1()  # function 1
foo.f2()  # function 2
foo.f3()  # function 3
foo.f4()  # function 4  function 1
